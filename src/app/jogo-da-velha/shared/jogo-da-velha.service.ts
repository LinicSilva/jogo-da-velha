...
export class JogoDaVelhaService {
  ...
  /**
   * Inicializa o jogo. exibição da tela inicial
   *
   * @return void
   */
  inicializar(): void {
  ...
  /**
   * Lógica para simular jogado do computador em modo aleatório.
   *
   * @return void
   */
  cpuJogar(): void {
  ...
  /**
   * Obtém a jogada válida para a vitória do jogador
   *
   *@param number jogador
   *@return number[]
   */
  ...
  /**
   * Retorna se peça X deve ser exibida para a
   * coodenada informada.
   *
   * @param number posX
   * @param number posY
  ...
  /**
   * Retorna se peça O deve ser exibida para a
   * coodenada informada.
   *
   * @param number posX
   * @param number posY
  ...
  /**
   * Retorna se a marcação d vitória deve ser exibida para a
